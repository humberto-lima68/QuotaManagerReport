		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Quota Manager - Report",
									"targetURL": "#QuotaManagerReport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"QuotaManagerReport-display": {
								"semanticObject": "QuotaManagerReport",
								"action": "display",
								"description": "Quota Manager - Report",
								"title": "Quota Manager - Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exed.com.quotamanager_report",
									"url": sap.ui.require.toUrl("exed/com/quotamanager_report")
								}
							}
						}
					}
