sap.ui.define([
	"sap/ui/test/Opa5",
	"exed/com/quotamanager_report/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("exed.com.quotamanager_report.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "exed.com.quotamanager_report",
					async: true
				},
				hash: oOptions.hash,
